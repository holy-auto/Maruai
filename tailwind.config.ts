  ...
  theme: {
    extend: {
      fontFamily: {
        ...
        heading: ['var(--font-heading)', '"Noto Serif JP"', 'serif'],
        display: ['var(--font-heading)', '"Noto Serif JP"', 'serif'],
        serif: ['var(--font-heading)', '"Noto Serif JP"', 'serif'],
      },
      animation: {
        'maruai-wiggle': 'maruai-wiggle 0.55s ease-in-out',
        'maruai-float': 'maruai-float 2.8s ease-in-out infinite',
      },
      colors: {
        primary: {
